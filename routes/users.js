...
const { protect, requireModulePermission, normalizeRole, getPublicRole } = require('../middleware/authMiddleware');
...
router.get('/', requireModulePermission('users', 'canRead'), asyncHandler(async (req, res) => {
...
router.get('/:id', requireModulePermission('users', 'canRead'), asyncHandler(async (req, res) => {
...
router.post('/', requireModulePermission('users', 'canCreate'), asyncHandler(async (req, res) => {
...
router.put('/:id', requireModulePermission('users', 'canWrite'), asyncHandler(async (req, res) => {
  const id = Number(req.params.id);
...
router.delete('/:id', requireModulePermission('users', 'canDelete'), asyncHandler(async (req, res) => {
  const id = Number(req.params.id);
